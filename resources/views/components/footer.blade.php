        ...
        <div class="flex gap-[100px] items-center">
            <div class="flex flex-col gap-[30px]">
                ...
                <div id="sosial-media" class="flex gap-[14px] items-center">
                    <a href="#"
                        class="bg-white rounded-full p-[15px] w-[40px] h-[40px] flex items-center justify-center">
            ...
            <div class="grid grid-cols-3 gap-[70px] content-center justify-end">
                ...
                <div class="flex flex-col gap-[30px]">
                    ...
                    <div class="flex flex-col gap-4">
                        <a href="#visi-misi" class="text-white">Sejarah Desa</a>
                        <a href="#visi-misi" class="text-white">Visi & Misi Desa</a>
                        <a href="#fasilitas" class="text-white">Fasilitas Desa</a>
                        <a href="#prestasi" class="text-white">Prestasi Desa</a>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-[30px]">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <a href="https://wa.me/+6287812741357" target="_blank" class="text-white">Whats App</a>
                        <a href="https://maps.app.goo.gl/6QcAhRHxBJJ7LPuy7" target="_blank" class="text-white">Lokasi & Peta</a>
                        <a href="#sosial-media" class="text-white">Sosial Media</a>
                    </div>
                </div>
